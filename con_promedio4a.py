...
# Asignar nota en función de asistencia (notas decimales)
...
# Calcular promedio final (peso 2 para nota1 + nota 2 y peso 1 para la asistencia)
...
# Mostrar promedio general y asistencia general
...
with st.expander("📋 Ver tabla de datos"):
    st.dataframe(df[["N°", "NOMBRES", "nota1", "nota 2", "promedio", "porcentaje_asistencia", "nota_asistencia", "promedio_final", "promedio_final_redondeado"]])
...
if "NOMBRES" in df.columns and not df["NOMBRES"].dropna().empty:
    ...
    st.write(df[df["NOMBRES"] == nombre_filtrado][["nota1", "nota 2", "promedio", "porcentaje_asistencia", "nota_asistencia", "promedio_final", "promedio_final_redondeado"]])
else:
